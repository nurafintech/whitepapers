...
[Tendermint's expected behavior](../4-%20Tendermint%20Expected%20Behavior/Readme.md) for details on the possible
call sequences of these methods.

- [**InitChain:**](../2-%20ABCI%20Methods/Readme.md#initchain) This method initializes the blockchain.
  Tendermint calls it once upon genesis.

- [**PrepareProposal:**](../2-%20ABCI%20Methods/Readme.md#prepareproposal) It allows the block
...
- [**ProcessProposal:**](../2-%20ABCI%20Methods/Readme.md#processproposal) It allows a validator to
...
- [**ExtendVote:**](../2-%20ABCI%20Methods/Readme.md#extendvote) It allows applications to force their
...
- [**VerifyVoteExtension:**](../2-%20ABCI%20Methods/Readme.md#verifyvoteextension) It allows
...
- [**FinalizeBlock:**](../2-%20ABCI%20Methods/Readme.md#finalizeblock) It delivers a decided block to the
...
- [**Commit:**](../2-%20ABCI%20Methods/Readme.md#commit) Instructs the Application to persist its
...
- [**CheckTx:**](../2-%20ABCI%20Methods/Readme.md#checktx) This method allows the Application to validate
...
- [**Info:**](../2-%20ABCI%20Methods/Readme.md#info) Used to sync Tendermint with the Application during a
  handshake that happens upon recovery, or on startup when state-sync is used.

- [**Query:**](../2-%20ABCI%20Methods/Readme.md#query) This method can be used to query the Application for
...
[snapshot data type](../2-%20ABCI%20Methods/Readme.md#snapshot) for more details). After receiving a
...
- [**ListSnapshots:**](../2-%20ABCI%20Methods/Readme.md#listsnapshots) Used by nodes to discover available
  snapshots on peers.

- [**OfferSnapshot:**](../2-%20ABCI%20Methods/Readme.md#offersnapshot) When a node receives a snapshot from a
  peer, Tendermint uses this method to offer the snapshot to the Application.

- [**LoadSnapshotChunk:**](../2-%20ABCI%20Methods/Readme.md#loadsnapshotchunk) Used by Tendermint to retrieve
  snapshot chunks from the Application to send to peers.

- [**ApplySnapshotChunk:**](../2-%20ABCI%20Methods/Readme.md#applysnapshotchunk) Used by Tendermint to hand
  snapshot chunks to the Application.

### Other methods

Additionally, there is a [**Flush**](../2-%20ABCI%20Methods/Readme.md#flush) method that is called on every connection,
and an [**Echo**](../2-%20ABCI%20Methods/Readme.md#echo) method that is used for debugging.
...
[ABCI++ vs. ABCI - Tendermint Github](https://github.com/tendermint/tendermint/blob/master/spec/abci%2B%2B/abci++_basic_concepts.md)